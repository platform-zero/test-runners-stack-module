...
const evidenceRules = new Map<string, EvidenceRule>([
  ...
  ['search-service/query', { label: 'OpenSearch BM25 query evidence', pattern: /OpenSearch Knowledge API|Query|Results/i }],
  ...
  ['planka/card-detail', { label: 'Planka seeded runtime-files card', pattern: /Intake call complete|Add healthchecks|operator runbook/i }],
  ...
  ['mastodon/draft', { label: 'Mastodon seeded draft post', pattern: /Northstar Portal Cleanup|Alice Morgan/i }],
  ...
  ['grafana/logs-dashboard', { label: 'Grafana logs dashboard rows', pattern: /All Logs|health|podman|Loki/i }],
  ['grafana/explore-logs', { label: 'Grafana explore log query', pattern: /All Logs|level=|health|podman/i }],
  ...
  ['grafana/service-health', { label: 'Grafana service health logs', pattern: /All Logs|health|service|podman/i }],
  ['grafana/query-drill', { label: 'Grafana query drill logs', pattern: /All Logs|health|service|podman/i }],
  ...
  ['erpnext/items', { label: 'ERPNext seeded runtime cleanup item', pattern: /INFRA-CLEANUP-REVIEW|Infrastructure Cleanup Review/i }],
  ...
  ['erpnext/projects', { label: 'ERPNext seeded runtime cleanup project', pattern: /Northstar Portal Cleanup|Expected End Date|Project Type/i }],
